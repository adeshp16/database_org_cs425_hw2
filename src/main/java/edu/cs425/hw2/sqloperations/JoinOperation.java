...
public class JoinOperation {
	...
	public void inOperationDeptEmp(List<Employee> employeeList, List<Department> deptList) {
		System.out.println(
				"*******************************************************************************************************************************************************************");
		System.out.println(
				"The result of IN query :  Select e.emp_id, e.emp_name, e.dept_id, e.address from employee  e where e.dept_id IN (Select d.dept_id from Department d where d.dept_name = cs) ");
		System.out.println(
				"*******************************************************************************************************************************************************************");
		System.out.println(
